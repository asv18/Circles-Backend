CREATE TABLE public.circle_post_connection (
  ...
  CONSTRAINT circle_post_connection_circle_id_fkey FOREIGN KEY (circle_id) REFERENCES public.circle(id) ON DELETE CASCADE,
  CONSTRAINT circle_post_connection_post_id_fkey FOREIGN KEY (post_id) REFERENCES public.circle_post(id) ON DELETE CASCADE,
